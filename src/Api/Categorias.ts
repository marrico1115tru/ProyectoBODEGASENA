...
export const createCategoriaProducto = async (data: CategoriaProductoFormValues): Promise<CategoriaProducto> => {
  const res = await axios.post(API_URL, data);
  return res.data;
};

export const updateCategoriaProducto = async (id: number, data: CategoriaProductoFormValues): Promise<CategoriaProducto> => {
